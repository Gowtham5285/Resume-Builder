...
import { Modal } from "../components/ResumeTemplates/Modal.jsx";
        ...
        <div className="container mx-auto px-6 py-6">
          ...
          <header className="flex justify-between items-center mb-16">
            ...
            {user ? <ProfileInfocard/>:<button
              className="bg-purple-100 text-sm font-semibold text-black px-7 py-2.5 rounded-lg hover:text-white hover:bg-gray-800 transition-colors cursor-pointer" onClick={() => setOpenAuthModal(true)}>
              Login / SignUp
            </button>}
          </header>
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
              ...
              <p className="text-lg text-gray-700 mb-8">
                Craft a standout resume in minutes with our smart and intutive resume builder.
              </p>
          ...
          <section className="mt-5 ">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
                ...
                <p className="text-gray-600">Update you resume with live preview and instant formatting.</p>
              </div>
